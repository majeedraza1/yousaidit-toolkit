...
const updateSettings = () => {
  return new Promise(resolve => {
    Spinner.show();
    axios
        .post('admin/stability-ai-logs/settings', {occasions: state.occasions})
        .then(response => {
          resolve(response.data.data);
          window.StackonetToolkit.stability_ai.occasions = response.data.data.occasions;
...
onMounted(() => {
  state.occasions = window.StackonetToolkit.stability_ai.occasions;
})
</script>
