...
const updateSettings = () => {
  return new Promise(resolve => {
    Spinner.show();
    axios
        .post('ai-content-generator/settings', {recipients: state.recipients})
        .then(response => {
...
onMounted(() => {
  state.recipients = window.StackonetToolkit.recipients;
})
</script>
...
<template>
  <div class='border-box-deep'>
    ...
    <ShaplaModal :active="state.showAddNewItemModal" title='Add New Recipient' @close="state.showAddNewItemModal = false">
