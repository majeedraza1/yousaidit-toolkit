const MINUTE_IN_MILLISECONDS: number = 1000 * 60;
const recordingTimeMS: number = 5 * MINUTE_IN_MILLISECONDS;

const formatBytes = (x: number): string => {
...
const initRecording = () => {
  ...
  let recording = document.querySelector<HTMLVideoElementWithCaptureStream>('#video-recording');
