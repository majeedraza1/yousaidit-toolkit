  ...
  <div class="yousaidit-designer-profile">
    ...
    <ShaplaTabs fullwidth tab-style="toggle">
      <ShaplaTab name="Personal Detail" selected>
        <ProfileField title="Name" :content="`${store.designer.first_name} ${store.designer.last_name}`"
                       @save="updateName">
        ...
        <ProfileField title="Display Name" :content="store.designer.display_name" @save="updateDisplayName">
          <ShaplaSelect
              label="Display Name"
        ...
        <ProfileField title="Location" :content="store.designer.location" @save="updateLocation">
          <ShaplaInput type="text" label="Location" v-model="store.designer.location"/>
        </ProfileField>

        <ProfileField title="Password" content="**********" @save="updatePassword">
        ...
        <ProfileField title="About Yourself" :content="store.designer.description" field-width="500px"
                       @save="updateDescription">
          <ShaplaInput type="textarea" label="Detail" v-model="store.designer.description"/>
        </ProfileField>

        <ProfileField title="Profile URL" :content="`${store.designer.profile_base_url}/${store.designer.user_login}`"
        ...
        <ProfileField title="Instagram Profile" :content="store.designer.instagram_url" field-width="500px"
      ...
      <ShaplaTab name="Business Detail">
        <ProfileField title="Business Name" :content="store.designer.business_name" @save="updateBusinessName">
          <ShaplaInput type="text" label="Business Name" v-model="store.designer.business_name"/>
        </ProfileField>

        <ProfileField title="Business Address" @save="updateBusinessAddress"
        ...
        <ProfileField title="VAT" :content="store.designer.vat_registration_number" @save="updateVatInfo">
      ...
      <ShaplaTab name="Payouts">
        <ProfileField title="PayPal Email Address" :content="store.designer.paypal_email" @save="updatePayPalEmail">
...
import {ShaplaButton, ShaplaInput, ShaplaMediaModal, ShaplaSelect, ShaplaTab, ShaplaTabs} from '@shapla/vue-components'
...
const restNonce = window.DesignerProfile.restNonce;
