...
const enabled_card_types = window.DesignerProfile.enabled_card_types;
const router = useRouter();
const redirectTo = (cardType: string) => {
  ...
  <div>
    <ShaplaColumns multiline>
      <ShaplaColumn :tablet="6" :desktop="4" :widescreen="3">
        <div class="relative">
          <div class="border border-solid border-primary rounded" @click="redirectTo('standard')">
            <div class="yousaidit-report-card__content">
              <img :src="store.standardCardUrl" alt="Standard Card">
            </div>
            <div class="text-center p-4 bg-primary rounded-b">
              <div class="text-white font-bold text-xl">Standard Card</div>
            </div>
          </div>
          <div v-if="!enabled_card_types.includes('standard')"
               class="absolute top-0 left-0 w-full h-full bg-white/90 flex justify-center items-center font-bold text-2xl text-primary">
            Coming soon
          </div>
        </div>
      </ShaplaColumn>
      <ShaplaColumn :tablet="6" :desktop="4" :widescreen="3">
        <div class="relative">
          <div class="border border-solid border-primary rounded" @click="redirectTo('photo-card')">
            ...
            <div class="text-center p-4 bg-primary rounded-b">
              <div class="text-white font-bold text-xl">Personalised Photo Card</div>
            </div>
          </div>
          <div v-if="!enabled_card_types.includes('photo-card')"
               class="absolute top-0 left-0 w-full h-full bg-white/90 flex justify-center items-center font-bold text-2xl text-primary">
            Coming soon
          </div>
        </div>
      ...
      <ShaplaColumn :tablet="6" :desktop="4" :widescreen="3">
        <div class="relative">
          ...
          <div v-if="!enabled_card_types.includes('text-card')"
               class="absolute top-0 left-0 w-full h-full bg-white/90 flex justify-center items-center font-bold text-2xl text-primary">
            Coming soon
          </div>
        </div>
      ...
      <ShaplaColumn :tablet="6" :desktop="4" :widescreen="3">
        <div class="relative">
          ...
          <div v-if="!enabled_card_types.includes('mug')"
               class="absolute top-0 left-0 w-full h-full bg-white/90 flex justify-center items-center font-bold text-2xl text-primary">
            Coming soon
          </div>
        </div>
