  ...
  <ShaplaColumns multiline v-if="Object.keys(card).length">
    <ShaplaColumn :tablet="12">
      <div class="w-full text-center">
        <h2 class="text-xl">{{ props.isMug ? 'Mug' : 'Card' }} Details</h2>
      </div>
    </ShaplaColumn>
    <ShaplaColumn :tablet="12">
      <div class="flex items-center">
        ...
        <span class="flex-grow">
					<span
              class="bg-primary text-on-primary text-sm py-4 px-2 inline-block">Is your design classed as a rude {{
              props.isMug ? 'mug' : 'card'
            }}?</span>
					<span class="bg-gray-100 text-sm py-4 px-2 inline-block">We class rude {{ props.isMug ? 'mugs' : 'cards' }} what contain words, phrases or themes of an adult content: i.e. swearing or innuendos.</span>
				</span>
      </div>
    </ShaplaColumn>
    <ShaplaColumn :tablet="6">
      <ShaplaInput
          ...
          :help-text="`Write ${props.isMug ? 'mug':'card'} title. ${props.isMug ? 'Mug':'Card'} title will be used as product title.`"
      />
    </ShaplaColumn>
    <ShaplaColumn :tablet="6" style="display: none">
      <ShaplaSelect
          ...
          :help-text="`Choose ${props.isMug ? 'mug':'card'} size(s). You need to upload file for each selected size on next step.`"
      />
    </ShaplaColumn>
    <ShaplaColumn :tablet="6">
      <ShaplaSelect
          ...
          :help-text="`Choose ${props.isMug ? 'mug':'card'} category. Try to choose only one category but not more than three categories.`"
      />
    </ShaplaColumn>
    <ShaplaColumn :tablet="6">
      <ShaplaSelect
          ...
          :help-text="`Choose ${props.isMug ? 'mug':'card'} tags. Choose as many tags as you need. Make sure tags are relevant to your ${props.isMug ? 'mug':'card'}.`"
      />
    </ShaplaColumn>
    <ShaplaColumn :tablet="6">
    ...
    <ShaplaColumn :tablet="12">
      <div class="card-description">
        ...
        <h4 class="font-normal text-sm">{{ props.isMug ? 'Mug' : 'Card' }} description will be visible on product detail page. Be creative as
    ...
    <ShaplaColumn :tablet="12" v-if="showMarketPlaces">
      <div class="market-places">
        <h3 class="font-normal text-lg text-primary uppercase">Where to list your {{ props.isMug ? 'mug' : 'card' }}</h3>
