...
class Filesystem {
	 ...
	 *
	 * @return bool|WP_Filesystem_Base|WP_Filesystem_Direct
	 */
	 ...
	 * @return array
	 */
	public static function get_uploads_dir( $sub_dir ) {
	 ...
	 * @return bool
	 */
	public static function update_file_content( $contents, $file ) {
		$filesystem = static::get_filesystem();
