...
export class DynamicCardLayer extends LitElement {
    ...
    sectionStyle() {
        ...
        if (this.section.userOptions && this.section.userOptions.top) {
            top += this.section.userOptions.top;
        }
        let left = this.section.position.left;
        if (this.section.userOptions && this.section.userOptions.left) {
            left += this.section.userOptions.left;
        }
        let styles = [],
