  ...
  <div class="flex -m-2">
    <div class="sm:w-full md:w-1/2 p-2">
      ...
      <div class="flex justify-center mt-4">
        <shapla-button v-if="hasImage" theme="primary" size="small" @click="removeImage">Remove Image</shapla-button>
      </div>
    </div>
    <div class="sm:w-full md:w-1/2 p-2">
      <div>
...
<script>
import {FileUploader, iconContainer, imageContainer, shaplaButton} from "shapla-vue-components";
