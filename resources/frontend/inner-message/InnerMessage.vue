...
export default {
  ...
  methods: {
    ...
    onUpdateMultiCompose(data) {
      ...
      let fieldsContainer = document.querySelector('#_inner_message_fields');
      if (fieldsContainer) {
        const leftPageContent = data.right;
        fieldsContainer.querySelector('#_inner_message_content').value = leftPageContent.message;
        fieldsContainer.querySelector('#_inner_message_font').value = leftPageContent.font_family;
        fieldsContainer.querySelector('#_inner_message_size').value = leftPageContent.font_size;
      ...
      if (imContainer2) {
        const rightPageContent = data.left;
        imContainer2.querySelector('#_inner_message2_type').value = 'text';
        imContainer2.querySelector('#_inner_message2_video_id').value = '';
        imContainer2.querySelector('#_inner_message2_content').value = rightPageContent.message;
        imContainer2.querySelector('#_inner_message2_font').value = rightPageContent.font_family;
        imContainer2.querySelector('#_inner_message2_size').value = rightPageContent.font_size;
