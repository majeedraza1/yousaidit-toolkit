                ...
                <div class="px-2">
                    <div>
                        ...
                        <select id="occasion" v-model="card_options.occasion">
                            <option v-for="(_occasion,value) in occasions" :value="value" :key="value">{{
                                _occasion
                                }}
                            </option>
                        </select>
                    ...
                    <div>
                        ...
                        <select id="Recipient" v-model="card_options.recipient">
                            <option v-for="(label,value) in recipients" :value="value" :key="value">{{ label }}</option>
                        </select>
                    </div>
                    <div>
                        <label for="Topic" class="text-center">Topic/Interests (optional)</label>
                        <select id="Topic" v-model="card_options.topic">
                            <option v-for="(label,value) in topics" :value="value" :key="value">{{ label }}</option>
                        </select>
                    </div>
                    <div>
                    ...
                    <div class="flex justify-center mt-4">
                        <shapla-button theme="primary" size="small" @click="generateContent">Write</shapla-button>
                    </div>
                </div>
            </div>
        </tab>
